...
def main(argv: list[str] | None = None) -> None:
    ...
    p_run.add_argument("--timeout", type=int, default=240, help="Timeout per query in seconds")
    ...
    p_quick.add_argument("--timeout", type=int, default=240, help="Timeout per query in seconds")
    ...
    p_opt.add_argument("--timeout", type=int, default=240, help="Timeout per query in seconds")
    ...
    p_collide.add_argument("--timeout", type=int, default=240, help="Timeout per query in seconds")
